...
export default () => {
  ...
  return (
    ...
    >
      <SwiperSlide>
      {({ isActive }) => (
        isActive ? <Image src={earth} className='w-[274px] h-[274px]' /> : <Image src={earth} className='w-[150px] h-[150px]' />
    )}</SwiperSlide>
      <SwiperSlide>
      {({ isActive }) => (
        isActive ? <Image src={mars} className='w-[274px] h-[274px]' /> : <Image src={mars} className='w-[150px] h-[150px]' />
    )}</SwiperSlide>
    <SwiperSlide>
      {({ isActive }) => (
        isActive ? <Image src={earth} className='w-[274px] h-[274px]' /> : <Image src={earth} className='w-[150px] h-[150px]' />
